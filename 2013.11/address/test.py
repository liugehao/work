...
res['rep1'] = re.compile(u'(.*?)\d*号(.*(工业园|博物馆|局|[一二三四五]期|分院|学院|大学|嘉园|家园|家属[区楼院]|银行|小区|公司|市场|中心|花园|苑|广场|酒店|大[楼厦院]|公司|学校|分校|宿舍|村屯|村庄|^村镇|^村街|^村路|庄村|^庄镇|^庄街|^庄路|庄屯|屯村|屯庄|^屯镇|村|庄|屯|幼儿园|小学|中学|号院|基地|政府|研究所|产业园|集团)).*$')
...
if __name__ == '__main__':
    ...
    u'钱姚路88号，龙山工业园5栋#xd;':(u'，龙山工业园',['钱姚路','88'])
    }
    for x in data:
        print x
