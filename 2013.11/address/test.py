...
res['rep1'] = re.compile(u'(路|街|道).*号(.*(博物馆|局|[一二三四五]期|分院|学院|大学|家园|家属[区楼院]|银行|小区|公司|市场|中心|花园|苑|广场|酒店|大[楼厦院]|公司|学校|分校|宿舍|村屯|村庄|^村镇|^村街|^村路|庄村|^庄镇|^庄街|^庄路|庄屯|屯村|屯庄|^屯镇|村|庄|屯|幼儿园|小学|中学|号院|基地)).*$')

res['rep2'] = re.compile(u'(博物馆|局|[一二三四五]期|分院|学院|大学|家园|家属[区楼院]|银行|小区|公司|市场|中心|花园|苑|广场|酒店|大[楼厦院]|公司|学校|分校|宿舍|村屯|村庄|^村镇|村街|村路|庄村|^庄镇|庄街|庄路|庄屯|屯村|屯庄|^屯镇|村|庄|屯|幼儿园|小学|中学|号院|基地).*$')
...
res['hao1'] = re.compile(u'(路|街|大道)(\d*)(-|号).*$')

hao0 = res['hao0'].sub(lambda x:str(num(x.group(0))), tmp1)
print hao0
print res['hao1'].sub(lambda x:x.group(1)+x.group(2) , hao0)
