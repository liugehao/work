# -*- coding: utf-8 -*-
#
# sql教程 documentation build configuration file, created by
# sphinx-quickstart on Wed Oct 23 09:00:20 2013.
#
...
latex_documents = [
  ('index', 'sql.tex', u'sql教程 Documentation',
   u' ', 'manual'),
]
...
man_pages = [
    ('index', 'sql', u'sql教程 Documentation',
     [u'李培吉'], 1)
]
...
texinfo_documents = [
  ('index', 'sql', u'sql教程 Documentation',
   u'李培吉', 'sql', 'One line description of project.',
   'Miscellaneous'),
]
