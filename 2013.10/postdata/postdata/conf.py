# -*- coding: utf-8 -*-
#
# postdata documentation build configuration file, created by
...
latex_documents = [
  ('index', 'postdata.tex', u'postdata Documentation',
   u'liuyou', 'manual'),
]
...
man_pages = [
    ('index', 'postdata', u'postdata Documentation',
     [u'liuyou'], 1)
]
...
texinfo_documents = [
  ('index', 'postdata', u'postdata Documentation',
   u'liuyou', 'postdata', 'One line description of project.',
   'Miscellaneous'),
]
