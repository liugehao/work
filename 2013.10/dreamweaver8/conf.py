# -*- coding: utf-8 -*-
#
# Dreamweaver 8 查找孤立文件 documentation build configuration file, created by
...
project = u'Dreamweaver 8 查找孤立文件'
copyright = u'2013, 刘友'
...
htmlhelp_basename = 'Dreamweaver8doc'
...
latex_documents = [
  ('index', 'Dreamweaver8.tex', u'Dreamweaver 8 查找孤立文件 Documentation',
   u'刘友', 'manual'),
]
...
man_pages = [
    ('index', 'dreamweaver8', u'Dreamweaver 8 查找孤立文件 Documentation',
     [u'刘友'], 1)
]
...
texinfo_documents = [
  ('index', 'Dreamweaver8', u'Dreamweaver 8 查找孤立文件 Documentation',
   u'刘友', 'Dreamweaver8', 'One line description of project.',
   'Miscellaneous'),
]
